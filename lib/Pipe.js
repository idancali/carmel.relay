...
const LOG = debug_1.default('carmel:pipe');
...
class Pipe {
    constructor(server, index) {
        ...
        this._join = index === 0 ? util_1.promisify(this.adapter.remoteJoin).bind(this.adapter) : this.adapter.remoteJoin.bind(this.adapter);
        this._leave = index === 0 ? util_1.promisify(this.adapter.remoteLeave).bind(this.adapter) : this.adapter.remoteLeave.bind(this.adapter);
        this._disconnect = index === 0 ? util_1.promisify(this.adapter.remoteDisconnect).bind(this.adapter) : this.adapter.remoteDisconnect.bind(this.adapter);
    }
    get server() {
        return this._server;
    }
